...
namespace DbFirstDaily.Controllers
{
    public class StudentDetailsController : Controller
    {
        ...
        {
            ViewBag.StudentDetailsId = new SelectList(db.Students, "StudentId", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "StudentDetailsId,Address,PhoneNumber,StudentId")] StudentDetails studentDetails)
        {
            ...
            ViewBag.StudentDetailsId = new SelectList(db.Students, "StudentId", "Name", studentDetails.StudentDetailsId);
            return View(studentDetails);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentDetailsId,Address,PhoneNumber,StudentId")] StudentDetails studentDetails)
        {
            if (ModelState.IsValid)
            {
